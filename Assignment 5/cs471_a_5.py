...
Original file is located at
    https://colab.research.google.com/drive/12xAwRFb0wBhluHE-xfMwiAQ8vtWyYyMg
"""
...
training_data = pd.read_csv("gdrive/MyDrive/Teaching/Fall2025/CS471/Assignments/training.csv", header=None, usecols=[19,23], names=['Time','Current'])
test_data = pd.read_csv("gdrive/MyDrive/Teaching/Fall2025/CS471/Assignments/test.csv", header=None, usecols=[0, 4], names=['Time','Current'])
